            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-background-subtle">
                  <th className="text-left px-5 py-3 text-xs uppercase tracking-[0.12em] text-foreground-subtle font-medium">
                    Title
                  </th>
                  <th className="text-left px-5 py-3 text-xs uppercase tracking-[0.12em] text-foreground-subtle font-medium hidden md:table-cell">
                    Category
                  </th>
                  <th className="text-left px-5 py-3 text-xs uppercase tracking-[0.12em] text-foreground-subtle font-medium hidden md:table-cell">
                    Date
              ...
              <tbody className="divide-y divide-border">
                {posts.map((post) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-5 py-4 text-foreground font-medium max-w-xs truncate">
                        {post.title}
                      </td>
